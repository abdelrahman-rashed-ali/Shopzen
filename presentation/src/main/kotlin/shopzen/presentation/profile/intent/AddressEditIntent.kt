...
sealed class AddressEditIntent {
    ...
    data class MapPinMoved(val latitude: Double, val longitude: Double) : AddressEditIntent()
    data object OpenMapScreen : AddressEditIntent()
    data object CloseMapScreen : AddressEditIntent()
