            ...
            Cart(
                items = listOf(
                    CartItem(
                        ...
                        productId = "p1",
                        variantId = "v1",
                        title = "Woman Sweater Woman Sweater Woman Sweater Woman Sweater Woman Sweater",
                        variantTitle = "Woman Fashion Woman Fashion Woman Fashion Woman Fashion Woman Fashion Woman Fashion",
                        price = 70.0,
                        quantity = 1,
                        maxQuantity = 10,
                        imageUrl = "",
